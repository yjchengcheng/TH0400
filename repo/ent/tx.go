...
func (tx *Tx) init() {
	...
	tx.TagTopic = NewTagTopicClient(tx.config)
	tx.Topic = NewTopicClient(tx.config)
	tx.User = NewUserClient(tx.config)
	tx.UserTopic = NewUserTopicClient(tx.config)
	tx.UserUser = NewUserUserClient(tx.config)
	tx.UserUserTopic = NewUserUserTopicClient(tx.config)
}
